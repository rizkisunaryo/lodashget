...
describe('lodashget', () => {
  ...
  it(`should return 'dasar' as defaultValue for lodashGet(obj, \`a.b[1][2]['coba']['lagi']['terus']\`)`, () => {
    ...
    assert.equal(
      lodashGet(obj, `a.b[1][2]['coba']['lagi']['terus']`, 'dasar'),
      'dasar'
    )
  })
  ...
  it(`should return default if array, but expected like object`, () => {
    const arr = [[1, [2, 3]], 4]
    assert.equal(
      lodashGet(arr, `a.b[1][2]['coba']['lagi']['terus']`, 'dasar'),
      'dasar'
    )
  })
  ...
  it(`should return undefined if expected doesn't exist, but no default value`, () => {
    ...
    assert.equal(
      lodashGet(obj, `a.b[1][2]['coba']['lagi']['terus']`),
      undefined
    )
  })
  ...
  it(`should return default, if whatToGet is undefined`, () => {
    const obj = { a: 1 }
    assert.equal(lodashGet(obj, undefined), undefined)
    assert.equal(lodashGet(obj, undefined, 'coba'), 'coba')
  })

  it(`should return default, if whatToGet is null`, () => {
    const obj = { a: 1 }
    assert.equal(lodashGet(obj, null), undefined)
    assert.equal(lodashGet(obj, null, 'coba'), 'coba')
  })
})
